package idv.cjcat.stardust.twoD.actions {
	...
	public class LazyAction extends CompositeAction {
		...
		public override function get mask():int { return super.mask; }
		public override function set mask(value:int):void {
			super.mask = 
			_move.mask = 
			_spin.mask = 
			_oriented.mask = 
		...
		public override function addAction(action:Action):void {
			super.addAction(action);
			additionalActions.addAction(action);
		}
		
		public override function removeAction(action:Action):void {
			super.removeAction(action);
			additionalActions.removeAction(action);
		}
		
		public override function clearActions():void {
			super.clearActions();
