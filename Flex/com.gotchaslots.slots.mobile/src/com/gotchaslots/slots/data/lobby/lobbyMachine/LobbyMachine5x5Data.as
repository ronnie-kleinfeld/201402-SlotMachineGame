package com.gotchaslots.slots.data.lobby.lobbyMachine
{
	...
	public class LobbyMachine5x5Data extends SlotsBaseLobbyMachineData
	{
		// properties
		protected final override function get ColumnFramesClass():Vector.<Class>
		{
			var columnFramesClass:Vector.<Class> = new Vector.<Class>();
			columnFramesClass.push(ColumnFramesEmebed.ColumnFrame5x5a);
			columnFramesClass.push(ColumnFramesEmebed.ColumnFrame5x5b);
		...
		protected final override function get SymetricFramesClass():Vector.<Class>
		{
			...
			symetricFramesClass.push(SymetricFramesEmbed.SymetricFrame5x5a);
			symetricFramesClass.push(SymetricFramesEmbed.SymetricFrame5x5b);
		...
		protected final override function get PayboxFramesClass():Vector.<Class>
		{
			...
			payboxFramesClass.push(PayboxesFramesEmbed.PayboxFrame5x5a);
			payboxFramesClass.push(PayboxesFramesEmbed.PayboxFrame5x5b);
			return payboxFramesClass;
		}
		protected final override function get PaylinesClass():Class
		{
			return Paylines5x5Data;
		}
		protected override function get MatrixPreviewClass():Class
		{
			return LinesEmbed5x5.MatrixPreview;
		}
		
		// class
		public function LobbyMachine5x5Data(id:int, machineName:String, normalSymbolsFunction:Function, bonusGameDataClass:Class, serverSymbolFileName:String, setPreviewSymbolID:int, factor:Number, maxPaylines:int, opensOnLevel:LevelData,
