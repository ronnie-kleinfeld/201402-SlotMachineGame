package com.gotchaslots.slots.ui.machine.presentation.strike
{
	...
	public class MegaWinPresentation extends BasePresentation
	{
		...
		// class
		public function MegaWinPresentation(onClick:Function, onClose:Function, view:SlotsMachineView)
		{
		...
		{
			Main.Instance.Sounds.Play(SlotsSoundsManager.Machine_Sequence_MegaWin_Animation);
		...
		protected override function DoPost():void
		{
			...
			Main.Instance.Application.Ticker.PushMessage("You Won: " + FormatterHelper.NumberToMoney(Main.Instance.ActiveMachine.Win), "Mega Win: " + FormatterHelper.NumberToMoney(_valuatorsHandler.Strike.Chips), true, 0);
