package com.gotchaslots.common.utils.helpers
{
	...
	public class TimeSpanHelper
	{
        ...
        public function TimeSpanHelper(milliseconds : Number)
        {
         ...
         * 
         */             
        public static function fromDates(start : Date, end : Date) : TimeSpanHelper
        {
                return new TimeSpanHelper(end.time - start.time);
        }
         ...
         */             
        public static function fromMilliseconds(milliseconds : Number) : TimeSpanHelper
        {
                return new TimeSpanHelper(milliseconds);
        }
         ...
         * @return A TimeSpan that represents the specified value
         */     
        public static function fromSeconds(seconds : Number) : TimeSpanHelper
        {
                return new TimeSpanHelper(seconds * MILLISECONDS_IN_SECOND);
        }
         ...
         * @return A TimeSpan that represents the specified value
         */     
        public static function fromMinutes(minutes : Number) : TimeSpanHelper
        {
                return new TimeSpanHelper(minutes * MILLISECONDS_IN_MINUTE);
        }
         ...
         * @return A TimeSpan that represents the specified value
         */     
        public static function fromHours(hours : Number) : TimeSpanHelper
        {
                return new TimeSpanHelper(hours * MILLISECONDS_IN_HOUR);
        }
         ...
         * @return A TimeSpan that represents the specified value
         */     
        public static function fromDays(days : Number) : TimeSpanHelper
        {
                return new TimeSpanHelper(days * MILLISECONDS_IN_DAY);
        }
