package com.gotchaslots.common.ui.notifications.popup.base
{
	...
	import com.gotchaslots.common.ui.notifications.popup.buttons.CloseButton;
	import com.gotchaslots.common.ui.notifications.popup.shape.PopupBG;
	import com.gotchaslots.common.ui.notifications.popup.textFields.PopupBlueMessageTextField;
	import com.gotchaslots.common.ui.notifications.popup.textFields.PopupPinkMessageTextField;
	...
	public class BasePopup extends BaseNotification
	{
		...
		{
			Main.Instance.Sounds.Play(SlotsSoundsManager.Popup_Collect_WinToBalance);
