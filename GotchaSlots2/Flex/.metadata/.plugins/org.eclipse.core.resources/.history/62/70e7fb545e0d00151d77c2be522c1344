package com.gotchaslots.common.ui.notifications.popup.invite4Unlock
{
	...
	public class Inviting4UnlockPopup extends BasePopup
	{
		...
		// class
		public function Inviting4UnlockPopup(lobbyMachine:SlotsBaseLobbyMachineData, onClose:Function)
		{
			super(onClose);
		...
		protected function OnInviteFriendsDialogComplete(event:SocialEvent):void
		{
			...
			{
				SlotsNotificationsHandler.Instance.ShowInvited4UnlockPopup(_lobbyMachine, newInviteesCount);
			}
			DoRemove();
		}
