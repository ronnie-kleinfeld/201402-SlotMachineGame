package com.gotchaslots.slots.ui.machine.presentation.strike
{
	...
	public class StrikePresentation extends BasePresentation
	{
		...
		// class
		public function StrikePresentation(onClick:Function, onClose:Function, view:SlotsMachineView, selectedPaylines:int)
		{
		...
		private function OnUpdate():void
		{
			...
			{
				Main.Instance.Sounds.Play(SlotsSoundsManager.Machine_Sequence_Strike_Blink);
			}
		}
	}
}