package com.gotchaslots.slots.mobile.ui.machine.presentation
{
	...
	public class FourInARowPresentation extends BasePresentation
	{
		...
		// class
		public function FourInARowPresentation(onClick:Function, onClose:Function, view:SlotsMachineView)
		{
		...
		{
			Main.Instance.Sounds.Play(SlotsSoundsManager.Machine_Sequence_FourInARow_Animation);
