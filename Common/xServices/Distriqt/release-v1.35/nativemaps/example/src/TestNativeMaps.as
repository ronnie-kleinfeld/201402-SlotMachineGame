...
package
{
	...
	public class TestNativeMaps extends Sprite
	{
		...
		static public const DEV_KEY	: String = "your-developer-key";
		...
		protected function mouseClickHandler( event:MouseEvent ):void
		{
			...
			switch (event.currentTarget)
			{
				...
				case _buttons[13]:
					...
					/*
					// Example of adding a polyline
					
					var polyline:Polyline = new Polyline(3, 0xFFFF0000 );
					polyline.name = "poly";
					...
					*/
					...
					trace("added marker : " + NativeMaps.service.addMarker( marker ));
					break;
				...
				case _buttons[14]:
					...
					marker2.animatesDrop = false;
					marker2.infoWindowEnabled = true;
					marker2.showInfoWindowButton = false;
