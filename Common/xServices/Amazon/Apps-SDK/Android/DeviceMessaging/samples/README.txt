...
To setup this sample in Eclipse:
...
7.  Open the ADM/lib folder, select the amazon-device-messaging-1.0.1.jar file, and click Open.
8.  You should now see amazon-device-messaging-1.0.1.jar listed in the Properties window. Click OK.
9.  In the Package Explorer for your project, under Referenced Libraries, amazon-device-messaging-1.0.1.jar should now appear.
10.  Copy and paste the contents of ADM/samples/ADMMessenger inside of your project (overwriting the existing files created by Eclipse).
