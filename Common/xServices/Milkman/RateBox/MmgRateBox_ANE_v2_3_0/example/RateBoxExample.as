...
public class RateBoxExample extends Sprite
{
	...
	{		
		...
		// here, we call it in the NativeApplication's InvokeEvent.INVOKE listener- because most app's run in the
	...
	/** Show the Ratings Page Immediately */
	public function showRatingsPageNow():void
	{
		log("Showing ratings page now...");
	...
	/** Use the iOS popover view for ratings instead of redirecting to the store.  This avoids leaving your app but also means the user will have to choose the Ratings button themselves inside the view */
	public function enableInlineStoreView():void
	{
		log("Will use inline store view.");
		RateBox.rateBox.setUseInlineStoreView(true);
	}
	
	public function disableInlineStoreView():void
	{
		log("will not use inline store view.");
	...
	public function createUI():void
	{
		...
		layout.addButton(new SimpleButton(new Command("Go to Ratings Page", showRatingsPageNow)));
		layout.addButton(new SimpleButton(new Command("Enable inline iOS View", enableInlineStoreView)));
		layout.addButton(new SimpleButton(new Command("Disable inline iOS View", disableInlineStoreView)));
